function AppDataModel() {
    ...
    // Routes
    var getWorkTimeRecordUrl = "/api/WorkTimeRecord",
        saveWorkTimeRecordUrl = "/api/WorkTimeRecord";

    // Data access for - WorkTimeRecord
    self.getWorkTimeRecords = function () {
        return $.ajax(getWorkTimeRecordUrl, {
            cache: false,
            headers: getSecurityHeaders()
        });
    };
    self.saveWorkTimeRecord = function (data) {
        return $.ajax(saveWorkTimeRecordUrl, {
    ...
    self.removeWorkTimeRecord = function (id) {
        return $.ajax(saveWorkTimeRecordUrl + '/' + id, {
            type: "DELETE", processData: false,
            //data: { id: id },
            headers: getSecurityHeaders()
        });
    };
    ...
    var getRegisteredUserUrl = "/api/Account/Users";

    // Data access for - WorkTimeRecord
    self.getRegisteredUsers = function () {
        return $.ajax(getRegisteredUserUrl, {
            cache: false,
            headers: getSecurityHeaders()
        });
    };
