...
using WaveWareTimes.Web.Providers;
using WaveWareTimes.Web.Results;
using System.Linq;
...
namespace WaveWareTimes.Web.Controllers.Api
{
    ...
    public class AccountController : ApiController
    {
        ...
        {
            var users = UserManager.Users.Select(e => new RegisteredUserModel
            {
                Id = e.Id,
                UserName = e.UserName,
            ...
            users.ForEach(e => { e.Roles = UserManager.GetRoles(e.Id); });
            return users;
        }
